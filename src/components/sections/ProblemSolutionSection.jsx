      ...
      <div className="mt-16 grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
        ...
        >
          ...
          <div className="relative h-full w-full rounded-lg border border-white/10 bg-[#1a0a2e]/60 p-8 backdrop-blur-xl">
            <div className="h-60 w-full rounded-md overflow-hidden border border-white/10">
              <img 
                src={dashboardImage} 
                alt="Dashboard do MedGuia mostrando gráficos e dados de pacientes" 
                className="h-full w-full object-countain"
              />
            </div>
